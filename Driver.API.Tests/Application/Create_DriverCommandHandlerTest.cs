...
{
    public class Create_DriverCommandHandlerTest
    {
        ...
        [Fact]
        public void Create_WithVaildDriverCommand_ReturnsResultSuccess()
        {
            //arrange
            ...
            moqDriverDbContext.Setup(m => m.Insert(It.IsAny<API.Domain.Entities.Driver>()))
                              .Returns(true);

            DriverCommandHandler commandHandler = new DriverCommandHandler(moqLogger.Object, moqDriverDbContext.Object);
            //act
            Result<string> actual = commandHandler.Create(driverCommand);
